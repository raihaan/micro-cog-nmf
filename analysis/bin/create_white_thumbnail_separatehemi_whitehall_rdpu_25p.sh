...
convert -gravity Center -background white +append $TMPDIR/left_medial.png $TMPDIR/left_lateral.png $TMPDIR/1.png
convert -gravity Center -background white +append $TMPDIR/right_medial.png $TMPDIR/right_lateral.png $TMPDIR/2.png
convert -resize 1000x1000 $TMPDIR/1.png ${outputbase}_left.png
convert -resize 1000x1000 $TMPDIR/2.png ${outputbase}_right.png
